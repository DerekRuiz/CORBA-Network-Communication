...
/**
* StoreMod/_StoreStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from F:/SOEN/SOEN423/Assignment2/build/classes/Store.idl
* Thursday, October 15, 2020 4:01:35 o'clock PM EDT
*/

public class _StoreStub extends org.omg.CORBA.portable.ObjectImpl implements StoreMod.Store
{
  ...
  public String[] listItemAvailability (String managerID)
  {
            ...
            try {
                ...
                $out.write_string (managerID);
                $in = _invoke ($out);
                String $result[] = StoreMod.ArrayHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();

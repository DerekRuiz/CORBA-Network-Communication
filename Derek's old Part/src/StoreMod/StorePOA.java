...
public abstract class StorePOA extends org.omg.PortableServer.Servant
 implements StoreMod.StoreOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // StoreMod/Store/removeItem
       {
         String managerID = in.read_string ();
         String itemID = in.read_string ();
         int quantity = in.read_long ();
       ...
       case 2:  // StoreMod/Store/listItemAvailability
       {
         String managerID = in.read_string ();
         String $result[] = null;
         $result = this.listItemAvailability (managerID);
         out = $rh.createReply();
         StoreMod.ArrayHelper.write (out, $result);
         break;
       }

       case 3:  // StoreMod/Store/purchaseItem
       {
       ...
       case 4:  // StoreMod/Store/findItem
       {
         String customerID = in.read_string ();
         String itemName = in.read_string ();
         String $result[] = null;
       ...
       case 5:  // StoreMod/Store/returnItem
       {
         String customerID = in.read_string ();
         String itemID = in.read_string ();
       ...
       case 6:  // StoreMod/Store/exchangeItem
       {
         String customerID = in.read_string ();
       ...
       case 7:  // StoreMod/Store/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;

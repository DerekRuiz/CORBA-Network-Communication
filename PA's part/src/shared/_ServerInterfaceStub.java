...
/**
* shared/_ServerInterfaceStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from IDL.idl
* Tuesday, October 20, 2020 9:19:02 o'clock PM EDT
*/

public class _ServerInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements shared.ServerInterface
{
  ...
  public String[] FindItem (String customerId, String itemDescription)
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                String $result[] = shared.ServerInterfacePackage.productsHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
